...
# experiment 3
python train.py --backbone xception --lr 0.001 --workers 4 --epochs 800 --batch-size 3 --test-batch-size 3 --groups 32 --base-size 513 --crop-size 513 --gpu-ids 0 --checkname deeplab-xception --eval-interval 1 --dataset cityscapes

# experiment 4
# python train.py --backbone xception --lr 0.001 --workers 4 --epochs 800 --batch-size 4 --test-batch-size 4 --base-size 513 --crop-size 513 --gpu-ids 0 --checkname deeplab-xception --eval-interval 1 --dataset cityscapes
